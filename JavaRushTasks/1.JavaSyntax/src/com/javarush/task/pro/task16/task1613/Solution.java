...
public class Solution {
    ...
    public static boolean isWeekend(LocalDateTime dateTime) {
        ...
        if ((dateTime.getDayOfWeek()== DayOfWeek.SATURDAY)||(dateTime.getDayOfWeek()== DayOfWeek.FRIDAY&&dateTime.getHour()>=22)||(dateTime.getDayOfWeek()== DayOfWeek.SUNDAY&&dateTime.getHour()<23)){
                return true;
        }
